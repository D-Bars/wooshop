...
?>
<div
	class="cart-summary p-3 sidebar cart_totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">
	...
	<div class="table-responsive">
		<table cellspacing="0" class="table shop_table shop_table_responsive">
			...
			<tr class="order-total">
				...
				<td data-title="<?php esc_attr_e('Total', 'woocommerce'); ?>"><h3>
					<?php wc_cart_totals_order_total_html(); ?></h3></td>
			</tr>
